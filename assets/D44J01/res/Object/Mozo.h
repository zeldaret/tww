...
enum dRes_INDEX_MOZO {
    ...
    /* BRK  */
    dRes_INDEX_MOZO_BRK_MOZ_e=0x9,
    /* BTK  */
    dRes_INDEX_MOZO_BTK_MOZ_e=0xC,
    /* BDLM */
    dRes_INDEX_MOZO_BDL_MOZ_e=0xF,
};

enum dRes_ID_MOZO {
    /* BCKS */
    dRes_ID_MOZO_BCK_MOZ_e=0x0,
    /* BRK  */
    dRes_ID_MOZO_BRK_MOZ_e=0x2,
    /* BTK  */
    dRes_ID_MOZO_BTK_MOZ_e=0x3,
    /* BDLM */
    dRes_ID_MOZO_BDL_MOZ_e=0x4,
};
