...
enum dRes_INDEX_SH {
    ...
    dRes_INDEX_SH_BAS_BUCHIWA_e=0xA,
    dRes_INDEX_SH_BAS_BUCHI_CHAKU_e=0xB,
    ...
    dRes_INDEX_SH_BCK_BUCHIWA_e=0x19,
    dRes_INDEX_SH_BCK_BUCHI_CHAKU_e=0x1A,
    dRes_INDEX_SH_BCK_PAWAY_e=0x1B,
    dRes_INDEX_SH_BCK_PFLY_e=0x1C,
    dRes_INDEX_SH_BCK_PHUKKI_e=0x1D,
    dRes_INDEX_SH_BCK_PUCHIWA_e=0x1E,
    dRes_INDEX_SH_BCK_PUCHI_CHAKU_e=0x1F,
    /* BMDM */
...
enum dRes_ID_SH {
    ...
    dRes_ID_SH_BAS_BUCHIWA_e=0xA,
    dRes_ID_SH_BAS_BUCHI_CHAKU_e=0xB,
    ...
    dRes_ID_SH_BCK_BUCHIWA_e=0x19,
    dRes_ID_SH_BCK_BUCHI_CHAKU_e=0x1A,
    dRes_ID_SH_BCK_PAWAY_e=0x1B,
    dRes_ID_SH_BCK_PFLY_e=0x1C,
    dRes_ID_SH_BCK_PHUKKI_e=0x1D,
    dRes_ID_SH_BCK_PUCHIWA_e=0x1E,
    dRes_ID_SH_BCK_PUCHI_CHAKU_e=0x1F,
    /* BMDM */
