...
namespace JAIGlobalParameter {
    ...
    const char* getParamInitDataFileName();
    const char* getParamWavePath();
    const char* getParamSequenceArchivesPath();
    const char* getParamStreamPath();
    const char* getParamAudioResPath();
    const char* getParamSequenceArchivesFileName();
