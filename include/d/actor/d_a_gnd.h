...
struct gnd_class {
    ...
    /* 0x0302 */ s16 m0302[5]; // 0 = mDamageTimer
    ...
    /* 0x13D4 */ JPABaseEmitter* mpAttackEffEmitter[6];
    /* 0x13EC */ JPABaseEmitter* m13EC;
    /* 0x13F0 */ JPABaseEmitter* m13F0[2];
#if VERSION > VERSION_DEMO
    /* 0x13F8 */ s16 mArrowHitEffectTimer[15];
    /* 0x1416 */ u8 m1416[0x1426 - 0x1416];
    /* 0x1426 */ s16 m1426;
    /* 0x1428 */ f32 m1428;
    /* 0x142C */ s16 mArrowHitFlashTimer;
    /* 0x142E */ s16 m142E;
    /* 0x1430 */ JPABaseEmitter* mpArrowHitEmitter[15];
    /* 0x146C */ u8 m146C[0x14A8 - 0x146C];
    /* 0x14A8 */ cXyz m14A8[15];
    /* 0x155C */ s16 m155C;
#endif
    /* 0x155E */ s16 m155E;
    /* 0x1560 */ s16 mKSubCount;
    /* 0x1562 */ s8 m1562;
