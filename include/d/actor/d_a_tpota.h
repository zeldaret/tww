...
//     /* 0x29C */ JPABaseEmitter* field_0x29C;
//     /* 0x2A0 */ cXyz field_0x2A0[2];
//     /* 0x2B8 */ csXyz field_0x2B8[2];
//     /* 0x2C4 */ JPABaseParticle field_0x2C4;
//     /* 0x398 */ u8 field_0x398[0x3DD - 0x398];
// };  // Size: 0x3DD
//     /* 0x290 */ u8 field_0x290[0x298 - 0x290];
//     /* 0x298 */ JPABaseEmitter* emitters[2];
//     /* 0x29C */ cXyz field_0x29C[2];
//     /* 0x2B4 */ csXyz field_0x2B4[2];
//     /* 0x2C0 */ unknown_struct field_0x2C0[30];
//     /* 0x3B0 */ u8 field_0x3B0[0x3D9 - 0x3B0];
// };  // Size: 0x3D9
    /* 0x290 */ u8 field_0x290[0x298 - 0x290];
    /* 0x298 */ JPABaseEmitter *emitters[2];
    /* 0x29C */ cXyz field_0x29C[2];
