...
public:
    ...
    inline u8 getEnableFlg() { return field_0x1; }
    inline int getRoomNo() { return m_no; }
    inline stage_map_info_class* getStageMapInfoP() { JUT_ASSERT(1127, mStageMapInfoP != NULL); return mStageMapInfoP; }
