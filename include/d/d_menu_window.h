...
enum dMw_Status {
    ...
    MW_STATUS_UNK_19 = 19,
    MW_STATUS_UNK_20 = 20,
    MW_STATUS_FMAP_OPEN = 21,
    MW_STATUS_FMAP_OPEN_WARP_MODE = 22,
    MW_STATUS_FMAP_OPEN_WALLPAPER = 23,
    MW_STATUS_FMAP_OPEN_FISHMAN_MODE = 24,
    MW_STATUS_FMAP_MOVE = 25,
    MW_STATUS_FMAP_MOVE_WARP_MODE = 26,
    MW_STATUS_FMAP_MOVE_WALLPAPER = 27,
    MW_STATUS_FMAP_MOVE_FISHMAN_MODE = 28,
    MW_STATUS_FMAP_CLOSE = 29,
    MW_STATUS_DMAP_OPEN = 30,
    MW_STATUS_DMAP_MOVE = 31,
    MW_STATUS_DMAP_CLOSE = 32,
    MW_STATUS_NAME_OPEN = 33,
    MW_STATUS_NAME_MOVE = 34,
    MW_STATUS_NAME_CLOSE = 35,
