...
class sub_mesg_class : public msg_class {
    public:
        ...
        /* 0x14C */ dMesg_screenDataTalk_c* screen;
...
public:
    ...
    int do_branch_queryResult();
    void do_branch(const void*, const char*);
    void do_character(int);
    bool do_tag(u32, const void*, u32);
    void setCharacter();
    void ruby_character(char*, int);
    bool do_systemTagCode(u16, const void*, u32);
    ...
    /* 0x07C */ int field_0x7c[1];
    /* 0x080 */ int field_0x80;
    /* 0x084 */ int field_0x84;
...
public:
    ...
    /* 0x1B4 */ fopMsgM_pane_class field_0x1b4[10];
    /* 0x3E4 */ u32 field_0x3e4;
    /* 0x3E8 */ u8 field_0x3e8[0x3EC - 0x3E8];
    /* 0x3EC */ void* texBuffer;
};
