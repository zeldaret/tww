...
enum {
    ...
    /* 0x4B */ DSNAP_TYPE_NPC_YW1,
    /* 0x4C */ DSNAP_TYPE_NPC_AJ1,
    /* 0x4D */ DSNAP_TYPE_NPC_JI1,
    /* 0x4E */ DSNAP_TYPE_NPC_YM2,
    /* 0x4F */ DSNAP_TYPE_NPC_OB1,
    /* 0x50 */ DSNAP_TYPE_NPC_YM1,
    /* 0x51 */ DSNAP_TYPE_NPC_KO2,
    /* 0x52 */ DSNAP_TYPE_NPC_KO1,
    /* 0x53 */ DSNAP_TYPE_UNK53,
    /* 0x54 */ DSNAP_TYPE_KB,
    /* 0x55 */ DSNAP_TYPE_KAMOME,
    /* 0x56 */ DSNAP_TYPE_KN,
    /* 0x57 */ DSNAP_TYPE_NPC_TT,
    /* 0x58 */ DSNAP_TYPE_NPC_KM1_KK1,
    /* 0x59 */ DSNAP_TYPE_NPC_GK1_KF1,
    /* 0x5A */ DSNAP_TYPE_NPC_PM1_KP1,
    /* 0x5B */ DSNAP_TYPE_NPC_PF1_GP1,
    /* 0x5C */ DSNAP_TYPE_NPC_BMS1,
    /* 0x5D */ DSNAP_TYPE_NPC_DS1,
    ...
    /* 0x76 */ DSNAP_TYPE_NPC_P2A,
    /* 0x77 */ DSNAP_TYPE_NPC_P2B,
    /* 0x78 */ DSNAP_TYPE_NPC_P2C,
    /* 0x79 */ DSNAP_TYPE_NPC_TC_NORMAL,
    /* 0x7A */ DSNAP_TYPE_NPC_TC_RED,
    /* 0x7B */ DSNAP_TYPE_NPC_TC_BLUE,
    /* 0x7C */ DSNAP_TYPE_NPC_TC_WHITE,
    /* 0x7D */ DSNAP_TYPE_NPC_SO,
    /* 0x7E */ DSNAP_TYPE_NPC_ROTEN,
    /* 0x7F */ DSNAP_TYPE_NPC_AH,
    /* 0x80 */ DSNAP_TYPE_NPC_BS1,
    /* 0x81 */ DSNAP_TYPE_NPC_KG1,
    /* 0x82 */ DSNAP_TYPE_NPC_SA1,
    /* 0x83 */ DSNAP_TYPE_IKADA,
    ...
    /* 0x8B */ DSNAP_TYPE_NPC_AC1_CO1,
    /* 0x8C */ DSNAP_TYPE_NPC_ZK1,
    /* 0x8D */ DSNAP_TYPE_NPC_PST,
    /* 0x8E */ DSNAP_TYPE_NPC_SKT_KKT,
    /* 0x8F */ DSNAP_TYPE_NPC_BMD_1,
    /* 0x90 */ DSNAP_TYPE_NPC_BMC,
    /* 0x91 */ DSNAP_TYPE_NPC_BMB_2,
    /* 0x92 */ DSNAP_TYPE_NPC_BMD,
    /* 0x93 */ DSNAP_TYPE_NPC_BMB_0_1,
    /* 0x94 */ DSNAP_TYPE_NPC_BMCON2,
    /* 0x95 */ DSNAP_TYPE_NPC_BMCON1,
    /* 0x96 */ DSNAP_TYPE_NPC_BMSW,
    /* 0x97 */ DSNAP_TYPE_NPC_BMC_3,
    /* 0x98 */ DSNAP_TYPE_NPC_BTSW,
    /* 0x99 */ DSNAP_TYPE_DR,
    /* 0x9A */ DSNAP_TYPE_NPC_HR,
    /* 0x9B */ DSNAP_TYPE_UNK9B,
    /* 0x9C */ DSNAP_TYPE_NPC_CB1,
    /* 0x9D */ DSNAP_TYPE_NPC_BJ1,
    /* 0x9E */ DSNAP_TYPE_NPC_BJ2,
    /* 0x9F */ DSNAP_TYPE_NPC_BJ3,
    /* 0xA0 */ DSNAP_TYPE_NPC_BJ4,
    /* 0xA1 */ DSNAP_TYPE_NPC_BJ5,
    /* 0xA2 */ DSNAP_TYPE_NPC_BJ6,
    /* 0xA3 */ DSNAP_TYPE_NPC_BJ7,
    /* 0xA4 */ DSNAP_TYPE_NPC_BJ8,
    /* 0xA5 */ DSNAP_TYPE_NPC_BJ9,
    /* 0xA6 */ DSNAP_TYPE_NPC_DE1,
    /* 0xA7 */ DSNAP_TYPE_NPC_MT,
    /* 0xA8 */ DSNAP_TYPE_NPC_MN,
