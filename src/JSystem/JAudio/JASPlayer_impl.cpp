...
const JASystem::TOscillator::Osc_ JASystem::Player::sEnvelopeDef = {
    0, 1.0f, NULL, JASystem::Player::sRelTable, 1.0f, 0.0f
};

const JASystem::TOscillator::Osc_ JASystem::Player::sVibratoDef = {
    1, 0.5f, JASystem::Player::sVibTable, JASystem::Player::sVibTable, 0.0f, 1.0f
};

const JASystem::TOscillator::Osc_ JASystem::Player::sTremoroDef = {
    0, 0.5f, JASystem::Player::sTreTable, JASystem::Player::sTreTable, 0.0f, 1.0f
};
