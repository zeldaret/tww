...
enum Action {
    ACTION_DOUSA = 0,
    ACTION_KOUGEKI = 1,
    ACTION_KARADA_TAORE = 2,
    ACTION_DAMAGE = 3,
    ACTION_BUNRI_DOUSA = 4,
...
enum Mode {
    ...
    MODE_KOUGEKI_60 = 60,
    MODE_KOUGEKI_61 = 61,
    MODE_KARADA_TAORE_70 = 70,
    MODE_KARADA_TAORE_71 = 71,
    MODE_KARADA_TAORE_72 = 72,
    MODE_KARADA_TAORE_73 = 73,
    MODE_KARADA_TAORE_74 = 74,
    MODE_KARADA_TAORE_75 = 75,
    MODE_KARADA_TAORE_76 = 76,
    MODE_KARADA_TAORE_77 = 77,
    MODE_KARADA_TAORE_78 = 78,
    MODE_KARADA_TAORE_79 = 79,
    MODE_DAMAGE_80 = 80,
    MODE_DAMAGE_81 = 81,
    MODE_DAMAGE_82 = 82,
    MODE_DAMAGE_83 = 83,
    MODE_DAMAGE_CARRIED = 84,
    MODE_DAMAGE_THROWN = 85,
    MODE_DAMAGE_86 = 86,
    MODE_DAMAGE_87 = 87,
    MODE_DAMAGE_90 = 90,
    MODE_DAMAGE_91 = 91,
    ...
    MODE_DAMAGE_100 = 100,
    MODE_DAMAGE_HIT = 101,
    MODE_BUNRI_DOUSA_INIT = 110,
    MODE_BUNRI_DOUSA_EXECUTE = 111,
    MODE_BUNRI_DOUSA_112 = 112,
    MODE_BUNRI_DOUSA_113 = 113,
    MODE_BUNRI_DOUSA_END_INIT = 114,
    MODE_BUNRI_DOUSA_END_GATHER = 115,
    MODE_BUNRI_DOUSA_END_GROW = 116,
    MODE_BUNRI_DOUSA_END_FINISH = 117,
    MODE_BUNRI_DOUSA_120 = 120,
    MODE_BUNRI_DOUSA_121 = 121,
    MODE_BUNRI_DOUSA_122 = 122,
    MODE_BUNRI_DOUSA_123 = 123,
    MODE_BUNRI_DOUSA_124 = 124,
    MODE_BUNRI_DOUSA_125 = 125,
    MODE_BUNRI_DOUSA_126 = 126,
    MODE_BUNRI_DOUSA_127 = 127,
    MODE_BUNRI_DOUSA_128 = 128,
    MODE_BUNRI_DOUSA_129 = 129,
    MODE_BUNRI_DOUSA_130 = 130,
    MODE_BUNRI_DOUSA_131 = 131,
    MODE_BUNRI_DOUSA_132 = 132,
    MODE_BUNRI_DOUSA_133 = 133,
    MODE_BUNRI_DOUSA_134 = 134,
    MODE_BUNRI_DOUSA_135 = 135,
    MODE_BUNRI_DOUSA_136 = 136,
    MODE_START_DEMO_200 = 200,
    MODE_START_DEMO_201 = 201,
    MODE_START_DEMO_202 = 202,
    MODE_START_DEMO_203 = 203,
    MODE_START_DEMO_204 = 204,
    MODE_START_DEMO_205 = 205,
    MODE_START_DEMO_206 = 206,
    MODE_START_DEMO_207 = 207,
    MODE_START_DEMO_208 = 208,
    MODE_START_DEMO_209 = 209,
    MODE_START_DEMO_210 = 210,
    MODE_START_DEMO_211 = 211,
    MODE_START_DEMO_212 = 212
};
...
static void draw_SUB(bpw_class* i_this) {
...
static void kantera_draw_SUB(bpw_class* i_this) {
    fopAc_ac_c* actor = &i_this->actor;
    J3DModel* model = i_this->mpMorf->getModel();
    model->setBaseScale(actor->scale);
...
static void body_draw(bpw_class* i_this) {
    fopAc_ac_c* actor = &i_this->actor;
    cXyz local_28;
    cXyz local_34;
...
static void kantera_draw(bpw_class* i_this) {
    fopAc_ac_c* actor = &i_this->actor;
    cXyz local_20;
    cXyz local_2c;
    cXyz local_38;
...
static void line_draw(bpw_class*) {
    /* Empty function */
}

/* 00000C24-00000CF0       .text torituki_draw__FP9bpw_class */
static void torituki_draw(bpw_class* i_this) {
...
static void anm_init(bpw_class* i_this, int bckFileIdx, f32 morf, u8 loopMode, f32 speed, int soundFileIdx) {
    i_this->m3F8 = bckFileIdx;
    if (soundFileIdx >= 0) {
        i_this->mpMorf
            ->setAnm((J3DAnmTransform*)dComIfG_getObjectRes("BPW", bckFileIdx), loopMode, morf, speed, 0.0f, -1.0f, dComIfG_getObjectRes("BPW", soundFileIdx));
    } else {
...
static BOOL body_atari_check(bpw_class* i_this) {
    fopAc_ac_c* actor = &i_this->actor;
    bool bVar2;
    cXyz local_4c;
    cXyz local_58;
    ...
    if (i_this->mMode != MODE_DAMAGE_83) {
        return FALSE;
    }
    switch (hitObj->GetAtType()) {
...
static void BG_check(bpw_class* i_this) {
    fopAc_ac_c* actor = &i_this->actor;
...
static s32 wall_HIT_check(bpw_class* i_this) {
    cXyz acStack_24;
    cXyz cStack_30;
    cXyz cStack_3c;
    cXyz local_48;
...
static void alpha_anime(bpw_class* i_this) {
    fopAc_ac_c* actor = &i_this->actor;
    if (i_this->m3E0 == 0) {
...
static void fuwafuwa_calc(bpw_class* i_this) {
    fopAc_ac_c* actor = &i_this->actor;
    i_this->m47C += 700;
...
static void kankyou_hendou(bpw_class* i_this) {
    f32 fVar1 = 0.0f;
    u8 bVar2 = 1;
...
static void noroi_check(bpw_class* i_this) {
    fopAc_ac_c* actor = &i_this->actor;
    fopAc_ac_c* player_actor = dComIfGp_getPlayer(0);
    daPy_py_c* player = (daPy_py_c*)player_actor;
    fopAc_ac_c* pdVar4;

    if ((!player->checkConfuse()) && (i_this->m47E != 0)) {
        if ((i_this->mAttWaitTimer != 1) && (i_this->mAttWaitTimer != 2) && (i_this->mAttWaitTimer != 0)) {
            return;
        }
        if ((i_this->m3F6 != 0) && (i_this->m3E6 == 0) && (i_this->mAction != ACTION_KARADA_TAORE) &&
            (i_this->mMode != MODE_DOUSA_10 && (i_this->mMode != MODE_DOUSA_11) && (i_this->mMode != MODE_DOUSA_12) && (i_this->mMode != MODE_DOUSA_13)))
        {
            if ((i_this->m3F8 == 42) || (i_this->m3F8 == 29) || (i_this->m3F8 == 28) || (i_this->m3F8 == 43)) {
                f32 f31 = 530.0f;
                if (fopAcM_searchPlayerDistance(actor) < f31) {
                    i_this->mAction = ACTION_KARADA_TAORE;
                    i_this->mMode = MODE_KARADA_TAORE_77;
                }
            }
        } else if ((i_this->mMode == MODE_DOUSA_5) || (i_this->mMode == MODE_DOUSA_6) || (i_this->mAction == ACTION_KARADA_TAORE)) {
            if ((i_this->mSomeCountdownTimers[3] == 0) && (i_this->mBodyAtSph.ChkAtHit())) {
                pdVar4 = i_this->mBodyAtSph.GetAtHitAc();
                if ((pdVar4 != NULL) && (pdVar4 == player_actor)) {
                    actor->speedF = 0.0f;
                    i_this->m490 = 0.0f;
                    i_this->mBodyCoSph.OffTgSetBit();
                    i_this->mBodyCoSph.ClrTgHit();
                    player->onConfuse();
                    i_this->mSomeCountdownTimers[3] = DEMO_SELECT(REG11_F(17) + 20, 20);
                    s32 r31 = ACTOR_TYPE_BODY;
                    csXyz local_28 = actor->shape_angle;
                    camera_class* camera = dComIfGp_getCamera(dComIfGp_getPlayerCameraID(0));
                    i_this->mFire1DousaPos = player->getHeadTopPos();
...
static void fire_and_emitter_clear(bpw_class* i_this) {
    bpw_class* pfVar1;
...
static void noroi_brk_check(bpw_class* i_this, u8 param_2) {
...
static BOOL next_att_wait_check(bpw_class* i_this) {
...
static void next_status_clear(bpw_class* i_this, u8 param_2) {
    fopAc_ac_c* actor = &i_this->actor;
...
static void light_on_off(bpw_class* i_this) {
...
static void* skull_search_sub(void* param_1, void* param_2) {
    UNUSED(param_2);
...
static void search_get_skull(bpw_class* i_this, u8 param_2) {
    fopAc_ac_c* actor = &i_this->actor;
    fopAc_ac_c* actor2;
    ...
    if (get_check_count != 0) {
        for (s32 i = 0; i < get_check_count; i++) {
            ...
            switch (param_2) {
                ...
                case 1:
                    if ((s16)cLib_distanceAngleS(actor->current.angle.y, fopAcM_searchActorAngleY(actor, actor2)) < 22000) {
                        if (i_this->mMode == MODE_KOUGEKI_53) {
...
static void maai_sub(bpw_class* i_this) {
    f32 dVar4;
    cXyz local_2c;
    cXyz local_38;
...
static void gouen_maai_sub(bpw_class* i_this) {
    f32 dVar3;
    f32 dVar4;
    cXyz local_3c;
    cXyz local_48;
    ...
    fopAc_ac_c* actor = &i_this->actor;
    dVar4 = (REG9_F(7) + 2.0f);
    if (fopAcM_searchPlayerDistance(actor) > REG9_F(9) + 500.0f) {
        cMtx_YrotS(*calc_mtx, fopAcM_searchPlayerAngleY(actor));
        local_3c.x = 0.0f;
        local_3c.y = 0.0f;
    ...
    if (fopAcM_searchPlayerDistance(actor) < (REG9_F(10) + 200.0f)) {
        cMtx_YrotS(*calc_mtx, fopAcM_searchPlayerAngleY(actor));
...
static s32 kantera_pos_search(bpw_class* i_this) {
    fopAc_ac_c* actor = &i_this->actor;
    f32 fVar1;
    f32 fVar2;
    fopAc_ac_c* pfVar3;
...
static void action_dousa(bpw_class* i_this) {
    ...
    switch (i_this->mMode) {
        case MODE_DOUSA_0:
            ...
            for (s32 i = 0; i < ARRAY_SSIZE(i_this->mSomeCountdownTimers); i++) {
        ...
        case MODE_DOUSA_1:
            ...
            // Fall-through
        case MODE_DOUSA_2:
            i_this->mSomeCountdownTimers[0] = 65;
            i_this->m490 = 10.0f;
            i_this->mSomeCountdownTimers[0] += (int)cM_rndF(i_this->mSomeCountdownTimers[0]);
            i_this->m488 = 1.0f;
            if (i_this->m3F6 == 2) {
                    ...
                    if (dComIfGp_getDetect().chk_light(&player->current.pos)) {
                        ...
                        if (cM_rnd() < 0.5f) {
                            ...
                            if (std::sqrtf(SQUARE(fVar15) + SQUARE(fVar3)) < f5) {
                                i_this->mAction = ACTION_KARADA_TAORE;
                                i_this->mMode = MODE_KARADA_TAORE_70;
                                break;
                            }
                        }
                        i_this->mMode = MODE_DOUSA_4;
        ...
        case MODE_DOUSA_4:
            ...
            i_this->mSomeCountdownTimers[0] = REG12_F(1) + 40.0f;
        ...
        case MODE_DOUSA_11:
            ...
            break;
        case MODE_DOUSA_12:
            cLib_addCalcAngleS2(&i_this->m47E, 150, 1, 0x1e);
            if (i_this->m47E >= 149) {
                i_this->m47E = 150;
                i_this->m480 = 150;
    ...
    if ((i_this->mMode != MODE_DOUSA_10) && (i_this->mMode != MODE_DOUSA_11) && (i_this->mMode != MODE_DOUSA_12) && (i_this->mMode != MODE_DOUSA_13)) {
        if (i_this->mMode != MODE_DOUSA_6) {
...
static void action_kougeki(bpw_class* i_this) {
    ...
    switch (i_this->mMode) {
        ...
        case MODE_KOUGEKI_21:
            ...
            if (i_this->m3E9 != 0) {
                i_this->mMode = MODE_KOUGEKI_50;
                i_this->m3E9 = 0;
            }
            break;
        case MODE_KOUGEKI_40:
            if (i_this->mSomeCountdownTimers[2] != 0)
                break;
        ...
        case MODE_KOUGEKI_42:
            i_this->m476 = fopAcM_searchPlayerAngleY(actor);
            search_get_skull(i_this, 2);
            if (i_this->mpMorf->isStop()) {
                i_this->mSomeCountdownTimers[0] = 90;
                i_this->mSomeCountdownTimers[0] += (int)cM_rndF(i_this->mSomeCountdownTimers[0]);
#if VERSION == VERSION_DEMO
                ...
                i_this->m510_demo = dComIfGp_particle_setToon(
                    dPa_name::ID_AK_ST_BPWBLOWSMOKE00,
                    &i_this->mFire1DousaPos,
                    &i_this->mFire1DousaRot,
                    NULL,
                    0xa0,
                    &i_this->m50C,
        ...
        case MODE_KOUGEKI_43:
            {
                ...
                if (i_this->mSomeCountdownTimers[0] != 0) {
                    ...
                    i_this->mSomeCountdownTimers[2] = REG12_F(7) + 90.0f;
                }
                break;
            }
        case MODE_KOUGEKI_50:
            anm_init(i_this, dRes_INDEX_BPW_BCK_SUIKOMU1_e, DEMO_SELECT(REG11_F(0) + 15.0f, 15.0f), J3DFrameCtrl::EMode_LOOP, 1.0f, -1);
            i_this->mSomeCountdownTimers[0] = 75;
            i_this->mSomeCountdownTimers[1] = REG8_F(2) + 20.0f;
            i_this->mKankyouHendouState = 2;
            i_this->mMode++;
            // Fall-through
        case MODE_KOUGEKI_51:
            {
#if VERSION == VERSION_DEMO
        ...
        case MODE_KOUGEKI_52:
            ...
            if (i_this->mpMorf->isStop()) {
                ...
                if (pfVar6 != NULL) {
                    ...
                    i_this->mSomeCountdownTimers[0] = 70;
                    i_this->mSomeCountdownTimers[0] += (int)cM_rndF(i_this->mSomeCountdownTimers[0]);
                    i_this->m47A = 0x300;
        ...
        case MODE_KOUGEKI_60:
            i_this->mSomeCountdownTimers[0] = 40;
            i_this->mSomeCountdownTimers[0] += (int)cM_rndF(i_this->mSomeCountdownTimers[0]);
...
static void action_karada_taore(bpw_class* i_this) {
    ...
    switch (i_this->mMode) {
        ...
        case MODE_KARADA_TAORE_71:
            ...
            if (i_this->mpMorf->checkFrame(DEMO_SELECT(REG11_F(15) + 26.0f, 26.0f))) {
                ...
                emitter = dComIfGp_particle_setToon(
                    dPa_name::ID_AK_ST_BPWJUMPSMOKE00,
                    &i_this->mFire1DousaPos,
                    &actor->shape_angle,
                    NULL,
                    0xB9,
        ...
        case MODE_KARADA_TAORE_72:
            ...
            break;
        case MODE_KARADA_TAORE_73:
            if (!i_this->mAcch.ChkGroundHit())
                break;
            fopAcM_seStart(actor, JA_SE_CM_BPW_J_BPRESS_PRESS, 0);
            actor->speed.setall(0.0f);
            actor->speedF = 0.0f;
            i_this->mMode = MODE_KARADA_TAORE_74;
        case MODE_KARADA_TAORE_74:
            fire_and_emitter_clear(i_this);
            i_this->m47E = 200;
            i_this->m480 = 200;
            i_this->m4A4 = 100.0f;
            ...
            i_this->m3E8 = 2;
            i_this->mSomeCountdownTimers[6] = REG21_F(0) + 20.0f;
            i_this->mFire1DousaPos = actor->current.pos;
            i_this->mFire1DousaPos.y = i_this->mAcch.GetGroundH();
            i_this->m5E0[2].remove();
            emitter = dComIfGp_particle_setToon(
                dPa_name::ID_AK_ST_BPWPRESSSMOKE00,
                &i_this->mFire1DousaPos,
                &actor->shape_angle,
                NULL,
                0xB9,
        ...
        case MODE_KARADA_TAORE_76:
            ...
            } else if ((i_this->m3F8 == 37) && (i_this->mpMorf->getFrame() >= DEMO_SELECT(40.0f, REG8_F(1) + 30.0f)) && (i_this->mAttWaitTimer == 0)) {
                i_this->mAttWaitTimer = 1;
            }
            if (i_this->mpMorf->isStop()) {
                i_this->m3AC.y = 340.0f;
        ...
        case MODE_KARADA_TAORE_78:
            ...
            if (i_this->mpMorf->checkFrame(40.0f)) {
                ...
                emitter = dComIfGp_particle_setToon(
                    dPa_name::ID_AK_ST_BPWPRESSSMOKE01,
                    &i_this->mFire1DousaPos,
                    &actor->shape_angle,
                    NULL,
                    0xB9,
...
static void action_damage(bpw_class* i_this) {
    fopAc_ac_c* actor = &i_this->actor;
    J3DAnmTevRegKey* pBrk;
    daPy_py_c* player = (daPy_py_c*)dComIfGp_getPlayer(0);
    J3DModel* model = i_this->mpMorf->getModel();
    switch (i_this->mMode) {
        case MODE_DAMAGE_80:
            ...
            i_this->mMode++;
        case MODE_DAMAGE_81:
            if ((i_this->mHitType == 10) || (i_this->mHitType == 11)) {
                if (i_this->mHitType == 11) {
                ...
                if (i_this->m47E >= 0xFF) {
                    ...
                    i_this->m478 = 0;
                    fopAcM_seStart(actor, JA_SE_CM_BPW_SOLID_END, 0);
                    i_this->mSomeCountdownTimers[0] = 18;
                    i_this->m3E0 = 1;
                    if (((i_this->mAttWaitTimer == 1) || (i_this->mAttWaitTimer == 2)) || (i_this->mAttWaitTimer == 0)) {
        ...
        case MODE_DAMAGE_CARRIED:
            ...
            if (i_this->mSomeCountdownTimers[9] == 0) {
                ...
                i_this->mSomeCountdownTimers[9] = 32;
            }
            if (!fopAcM_checkCarryNow(actor)) {
                actor->gravity = -3.0f;
                actor->speed.y = 10.0f;
                ...
                i_this->mMode = MODE_DAMAGE_THROWN;
        ...
        case MODE_DAMAGE_100:
            ...
            i_this->mMode++;
            break;
        case MODE_DAMAGE_HIT:
            actor->shape_angle.y += 0x1500;
            cLib_addCalcAngleS2(&actor->shape_angle.x, 0, 10, 0x2000);
            if (i_this->mAcch.ChkGroundHit()) {
                i_this->m3E8 = 2;
                i_this->mSomeCountdownTimers[6] = REG21_F(0) + 20.0f;
                ...
                JPABaseEmitter* emitter = dComIfGp_particle_setToon(
                    dPa_name::ID_AK_ST_BPWSIRIMOTISMOKE00,
                    &i_this->mFire1DousaPos,
                    &actor->shape_angle,
                    NULL,
                    0xB9,
                ...
                i_this->m3E9 = 0;
                for (i = 0; i < ARRAY_SSIZE(i_this->mChildPoeIds); i++) {
...
#endif
                i_this->mAction = ACTION_BUNRI_DOUSA;
                i_this->mMode = MODE_BUNRI_DOUSA_INIT;
            }
    }
...
/**
 * "action_separation_update"
 */
/* 000062D8-00008BAC       .text action_bunri_dousa__FP9bpw_class */
static void action_bunri_dousa(bpw_class* i_this) {
    ...
    switch (i_this->mMode) {
        case MODE_BUNRI_DOUSA_INIT:
            {
                ...
                i_this->mSomeCountdownTimers[0] = DEMO_SELECT(390, 420);
                i_this->mMode++;
            }
        case MODE_BUNRI_DOUSA_EXECUTE:
            {
                ...
                if (actor->health <= 0) {
                    if (dComIfGp_getStartStageName()[0] == 'X') {
                        ...
                        i_this->mBodyCoSph.OffTgSetBit();
                        i_this->mBodyCoSph.ClrTgHit();
                        i_this->mMode = MODE_BUNRI_DOUSA_120;
                    }
                    break;
                }
        ...
        case MODE_BUNRI_DOUSA_113:
            ...
            i_this->mCSFovY = 50.0f;
            i_this->m3E0 = 0;
            i_this->m480 = 150;
            i_this->mSomeCountdownTimers[2] = 15;
            i_this->m474 = 1;
            sp70.x = 0.0f;
            sp70.y = 0.0f;
            sp70.z = 1625.0f;
            ...
            i_this->mMode++;
        case MODE_BUNRI_DOUSA_END_INIT:
            i_this->mCSCamCenter.set(156.0f, 515.0f, 1001.0f);
            i_this->mCSCamEye.set(181.0f, 603.0f, 1196.0f);
            if (REG20_S(1) == 0) {
                REG20_S(0) = 1;
            }
            if (REG20_S(0) == 0) {
            ...
            fuwafuwa_calc(i_this);
            break;
        case MODE_BUNRI_DOUSA_END_GATHER:
            if (i_this->mSomeCountdownTimers[0] == 0) {
                if (REG20_S(1) == 0) {
                    REG20_S(0) = 1;
                }
            ...
            break;
        case MODE_BUNRI_DOUSA_END_GROW:
            f3 = std::fabsf(i_this->mCSCamCenter.x - (REG20_F(12) + 152.0f));
            f3 *= REG20_F(18) + 0.08f;
            cLib_addCalc2(&i_this->mCSCamCenter.x, REG20_F(12) + 152.0f, 1.0f, DEMO_SELECT(f3, f3 * i_this->m43C));
            f3 = std::fabsf(i_this->mCSCamCenter.y - (REG20_F(13) + 498.0f));
            f3 *= REG20_F(18) + 0.08f;
            cLib_addCalc2(&i_this->mCSCamCenter.y, REG20_F(13) + 498.0f, 1.0f, DEMO_SELECT(f3, f3 * i_this->m43C));
            f3 = std::fabsf(i_this->mCSCamCenter.z - (REG20_F(14) + 983.0f));
            f3 *= REG20_F(18) + 0.08f;
            cLib_addCalc2(&i_this->mCSCamCenter.z, REG20_F(14) + 983.0f, 1.0f, DEMO_SELECT(f3, f3 * i_this->m43C));
            f3 = std::fabsf(i_this->mCSCamEye.x - (REG20_F(15) + 181.0f));
            f3 *= REG20_F(18) + 0.08f;
            cLib_addCalc2(&i_this->mCSCamEye.x, REG20_F(15) + 181.0f, 1.0f, DEMO_SELECT(f3, f3 * i_this->m43C));
            f3 = std::fabsf(i_this->mCSCamEye.y - (REG20_F(16) + 504.0f));
            f3 *= REG20_F(18) + 0.08f;
            cLib_addCalc2(&i_this->mCSCamEye.y, REG20_F(16) + 504.0f, 1.0f, DEMO_SELECT(f3, f3 * i_this->m43C));
            f3 = std::fabsf(i_this->mCSCamEye.z - (REG20_F(17) + 1196.0f));
            f3 *= REG20_F(18) + 0.08f;
            cLib_addCalc2(&i_this->mCSCamEye.z, REG20_F(17) + 1196.0f, 1.0f, DEMO_SELECT(f3, f3 * i_this->m43C));
#if VERSION > VERSION_DEMO
            ...
            if (i_this->mpMorf->isStop()) {
                ...
                REG20_S(0) = 0;
                anm_init(i_this, dRes_INDEX_BPW_BCK_WAIT1_e, DEMO_SELECT(REG11_F(0) + 15.0f, 15.0f), J3DFrameCtrl::EMode_LOOP, 1.0f, -1);
                i_this->mSomeCountdownTimers[0] = DEMO_SELECT(REG11_F(10) + 20.0f, 20);
                i_this->mMode++;
            }
            break;
        case MODE_BUNRI_DOUSA_END_FINISH:
            if (REG20_S(1) == 0) {
                REG20_S(0) = 1;
            }
            if (REG20_S(0) == 0) {
            ...
            camera->mCamera.Reset(i_this->mCSCamCenter, i_this->mCSCamEye);
        ...
        case MODE_BUNRI_DOUSA_120:
            ...
            anm_init(i_this, dRes_INDEX_BPW_BCK_CORE1_e, DEMO_SELECT(REG11_F(0) + 15.0f, 15.0f), J3DFrameCtrl::EMode_LOOP, 1.0f, -1);
            if (i_this->m3FC != fpcM_ERROR_PROCESS_ID_e) {
                pw_class* childPoe2 = (pw_class*)fopAcM_SearchByID(i_this->m3FC);
                fopAcM_createDisappear(childPoe2, &childPoe2->current.pos, 5, daDisItem_NONE3_e);
                fopAcM_delete(childPoe2);
            }
            ...
            if (childPoe != NULL) {
                ...
                i_this->m464 = fopAcM_searchPlayerAngleY(childPoe);
#else
                i_this->mCSCamCenter = childPoe->current.pos;
#endif
            }
        case MODE_BUNRI_DOUSA_121:
#if VERSION > VERSION_DEMO
            childPoe = (pw_class*)fopAcM_SearchByID(i_this->mChildPoeIds[i_this->m462]);
            if (childPoe != NULL) {
                i_this->m424 = childPoe->current.pos;
            ...
            i_this->mCSFovY = 50.0f;
#if VERSION == VERSION_DEMO
            i_this->mCSCamCenter = i_this->m424;
            i_this->mCSCamCenter.y += 150.0f + REG12_F(17);
#else
            i_this->mCSCamCenter.x = i_this->m424.x;
            i_this->mCSCamCenter.z = i_this->m424.z;
            cLib_addCalc2(&i_this->mCSCamCenter.y, i_this->m424.y + 150.0f + REG12_F(17), 0.1f, 10.0f);
#endif
            ...
            i_this->mCSCamEye.x = local_74.x;
            i_this->mCSCamEye.y = local_74.y + 100.0f;
            i_this->mCSCamEye.z = local_74.z;
#else
            local_74.x += i_this->m424.x;
            local_74.z += i_this->m424.z;
            local_74.y += i_this->m424.y * 0.3f;
            i_this->mCSCamEye.set(local_74.x, local_74.y + 100.0f, local_74.z);
#endif
            if (i_this->mSomeCountdownTimers[0] == 0) {
            ...
            break;
        case MODE_BUNRI_DOUSA_122:
            actor->shape_angle.y = fopAcM_searchPlayerAngleY(actor);
            actor->current.angle.y = actor->shape_angle.y;
            i_this->m476 = actor->shape_angle.y;
            cLib_addCalc2(&i_this->mCSFovY, REG20_F(2) + 50.0f, 1.0f, 0.5f);
            i_this->mCSCamCenter.set(-484.0f, 628.0f, -1495.0f);
            i_this->mCSCamEye.set(-527.0f, 698.0f, -1645.0f);
            sp70.x = -36.0f;
            sp70.y = player->current.pos.y;
            sp70.z = -777.0f;
...
#endif
            // Fall-through
        case MODE_BUNRI_DOUSA_123:
            if (i_this->mSomeCountdownTimers[0] != 0) {
                i_this->mSomeCountdownTimers[1] = REG20_F(10) + 100.0f;
                i_this->mSomeCountdownTimers[4] = REG12_F(12) + 30.0f;
                break;
            }
            cLib_addCalc2(&i_this->mCSFovY, REG20_F(11) + 50.0f, 1.0f, 0.5f);
            f3 = std::fabsf(i_this->mCSCamCenter.x - (REG20_F(12) + -114.0f));
            f3 *= REG20_F(18) + 0.02f;
            cLib_addCalc2(&i_this->mCSCamCenter.x, REG20_F(12) + -114.0f, DEMO_SELECT(1.0f, 0.1f), DEMO_SELECT(f3, f3 * i_this->m43C));
            f3 = std::fabsf(i_this->mCSCamCenter.y - (REG20_F(13) + 95.0f));
            f3 *= REG20_F(18) + 0.02f;
            cLib_addCalc2(&i_this->mCSCamCenter.y, REG20_F(13) + 95.0f, DEMO_SELECT(1.0f, 0.1f), DEMO_SELECT(f3, f3 * i_this->m43C));
            f3 = std::fabsf(i_this->mCSCamCenter.z - (REG20_F(14) + -293.0f));
            f3 *= REG20_F(18) + 0.02f;
            cLib_addCalc2(&i_this->mCSCamCenter.z, REG20_F(14) + -293.0f, DEMO_SELECT(1.0f, 0.1f), DEMO_SELECT(f3, f3 * i_this->m43C));
            f3 = std::fabsf(i_this->mCSCamEye.x - (REG20_F(15) + -169.0f));
            f3 *= REG20_F(18) + 0.02f;
            cLib_addCalc2(&i_this->mCSCamEye.x, REG20_F(15) + -169.0f, 1.0f, DEMO_SELECT(f3, f3 * i_this->m43C));
            f3 = std::fabsf(i_this->mCSCamEye.y - (REG20_F(16) + 98.0f));
            f3 *= REG20_F(18) + 0.02f;
            cLib_addCalc2(&i_this->mCSCamEye.y, REG20_F(16) + 98.0f, 1.0f, DEMO_SELECT(f3, f3 * i_this->m43C));
            f3 = std::fabsf(i_this->mCSCamEye.z - (REG20_F(17) + -462.0f));
            f3 *= REG20_F(18) + 0.02f;
            cLib_addCalc2(&i_this->mCSCamEye.z, REG20_F(17) + -462.0f, 1.0f, DEMO_SELECT(f3, f3 * i_this->m43C));
#if VERSION > VERSION_DEMO
            cLib_addCalc2(&i_this->m43C, 1.0f, 1.0f, 0.04f);
#endif
            if (i_this->m3F8 == 27) {
        ...
        case MODE_BUNRI_DOUSA_124:
            ...
            i_this->mMode++;
            // Fall-through
        case MODE_BUNRI_DOUSA_125:
            cLib_addCalc2(&i_this->mCSFovY, REG19_F(1) + 50.0f, 1.0f, 0.5f);
            i_this->mCSCamCenter.set(61.0f, 125.0f, -159.0f);
            i_this->mCSCamEye.set(-146.0f, 39.0f, -965.0f);
            if (i_this->mSomeCountdownTimers[0] != 0) {
                break;
            }
            if (REG20_S(1) == 0) {
...
#endif
            // Fall-through
        case MODE_BUNRI_DOUSA_126:
            {
                if (i_this->mSomeCountdownTimers[0] == 0) {
                    fopAcM_seStart(actor, JA_SE_CM_BPW_MASK_RUN_AWAY, 0);
                }
                cLib_addCalc2(&i_this->mCSFovY, REG19_F(9) + 50.0f, 1.0f, 0.5f);
                f3 = std::fabsf(i_this->mCSCamCenter.x - (REG19_F(10) + -471.0f));
                f3 *= REG19_F(12) + 0.05f;
                cLib_addCalc2(&i_this->mCSCamCenter.x, REG19_F(10) + -471.0f, DEMO_SELECT(1.0f, 0.1f), DEMO_SELECT(f3, f3 * i_this->m43C));
                f3 = std::fabsf(i_this->mCSCamCenter.y - (REG19_F(10) + 120.0f));
                f3 *= REG19_F(12) + 0.05f;
                cLib_addCalc2(&i_this->mCSCamCenter.y, REG19_F(10) + 120.0f, DEMO_SELECT(1.0f, 0.1f), DEMO_SELECT(f3, f3 * i_this->m43C));
                f3 = std::fabsf(i_this->mCSCamCenter.z - (REG19_F(11) + -498.0f));
                f3 *= REG19_F(12) + 0.05f;
                cLib_addCalc2(&i_this->mCSCamCenter.z, REG19_F(11) + -498.0f, DEMO_SELECT(1.0f, 0.1f), DEMO_SELECT(f3, f3 * i_this->m43C));
                f3 = std::fabsf(i_this->mCSCamEye.x - (REG20_F(15) + 115.0f));
                f3 *= REG19_F(12) + 0.05f;
                cLib_addCalc2(&i_this->mCSCamEye.x, REG20_F(15) + 115.0f, 1.0f, DEMO_SELECT(f3, f3 * i_this->m43C));
                f3 = std::fabsf(i_this->mCSCamEye.y - (REG20_F(16) + 58.0f));
                f3 *= REG19_F(12) + 0.05f;
                cLib_addCalc2(&i_this->mCSCamEye.y, REG20_F(16) + 58.0f, 1.0f, DEMO_SELECT(f3, f3 * i_this->m43C));
                f3 = std::fabsf(i_this->mCSCamEye.z - (REG20_F(17) + -1062.0f));
                f3 *= REG19_F(12) + 0.05f;
                cLib_addCalc2(&i_this->mCSCamEye.z, REG20_F(17) + -1062.0f, 1.0f, DEMO_SELECT(f3, f3 * i_this->m43C));
#if VERSION > VERSION_DEMO
                cLib_addCalc2(&i_this->m43C, 1.0f, 1.0f, 0.04f);
#endif
        ...
        case MODE_BUNRI_DOUSA_127:
            ...
            cLib_addCalc2(&i_this->mCSFovY, REG19_F(15) + 50.0f, 1.0f, 0.5f);
            f3 = std::fabsf(i_this->mCSCamCenter.x - (REG19_F(16) + -538.0f));
            f3 *= REG19_F(19) + 0.04f;
            cLib_addCalc2(&i_this->mCSCamCenter.x, REG19_F(16) + -538.0f, DEMO_SELECT(1.0f, 0.1f), DEMO_SELECT(f3, f3 * i_this->m43C));
            f3 = std::fabsf(i_this->mCSCamCenter.y - (REG19_F(17) + 748.0f));
            f3 *= REG19_F(19) + 0.04f;
            cLib_addCalc2(&i_this->mCSCamCenter.y, REG19_F(17) + 748.0f, DEMO_SELECT(1.0f, 0.1f), DEMO_SELECT(f3, f3 * i_this->m43C));
            f3 = std::fabsf(i_this->mCSCamCenter.z - (REG19_F(18) + -567.0f));
            f3 *= REG19_F(19) + 0.04f;
            cLib_addCalc2(&i_this->mCSCamCenter.z, REG19_F(18) + -567.0f, DEMO_SELECT(1.0f, 0.1f), DEMO_SELECT(f3, f3 * i_this->m43C));
#if VERSION > VERSION_DEMO
            cLib_addCalc2(&i_this->m43C, 1.0f, 1.0f, 0.04f);
#endif
            if (i_this->mSomeCountdownTimers[0] == 1) {
        ...
        case MODE_BUNRI_DOUSA_128:
            ...
            i_this->mMode++;
            // Fall-through
        case MODE_BUNRI_DOUSA_129:
            if (i_this->mSomeCountdownTimers[1] == 1) {
                mDoAud_bgmStreamPlay();
            }
            cLib_addCalcAngleS2(&i_this->m47E, i_this->m480, 1, 5);
            cLib_addCalc2(&i_this->mCSFovY, REG18_F(9) + 50.0f, 1.0f, 0.5f);
            i_this->mCSCamCenter.set(-1030.0f, 2017.0f, 119.0f);
            i_this->mCSCamEye.set(-1332.0f, 2722.0f, -153.0f);
        ...
        case MODE_BUNRI_DOUSA_131:
            ...
            i_this->mMode++;
            // Fall-through
        case MODE_BUNRI_DOUSA_132:
            cLib_addCalc2(&i_this->mCSFovY, REG6_F(7) + 50.0f, 1.0f, 0.5f);
            i_this->mCSCamCenter.set(-893.0f, 1874.0f, 66.0f);
            i_this->mCSCamEye.x = 142.0f;
            i_this->mCSCamEye.y = 68.0f;
            i_this->mCSCamEye.z = -1348.0f;
            if (REG20_S(1) == 0) {
                REG20_S(0) = 1;
            }
            if (REG20_S(0) == 0) {
...
#endif
            // Fall-through
        case MODE_BUNRI_DOUSA_133:
            cLib_addCalcAngleS2(&actor->shape_angle.x, REG18_F(19) + 49152.0f, 1, 0x300);
            cLib_addCalcAngleS2(&actor->shape_angle.z, 0, 1, 0x300);
            cLib_addCalc2(&i_this->mCSFovY, REG6_F(7) + 50.0f, 1.0f, 0.5f);
            f3 = std::fabsf(i_this->mCSCamCenter.x - (REG6_F(8) + -1352.0f));
            f3 *= REG6_F(6) + 0.05f;
            cLib_addCalc2(&i_this->mCSCamCenter.x, REG6_F(8) + -1352.0f, DEMO_SELECT(1.0f, 0.1f), DEMO_SELECT(f3, f3 * i_this->m43C));
            f3 = std::fabsf(i_this->mCSCamCenter.y - (REG6_F(9) + 174.0f));
            f3 *= REG6_F(6) + 0.05f;
            cLib_addCalc2(&i_this->mCSCamCenter.y, REG6_F(9) + 174.0f, DEMO_SELECT(1.0f, 0.1f), DEMO_SELECT(f3, f3 * i_this->m43C));
            f3 = std::fabsf(i_this->mCSCamCenter.z - (REG6_F(10) + 680.0f));
            f3 *= REG6_F(6) + 0.05f;
            cLib_addCalc2(&i_this->mCSCamCenter.z, REG6_F(10) + 680.0f, DEMO_SELECT(1.0f, 0.1f), DEMO_SELECT(f3, f3 * i_this->m43C));
#if VERSION > VERSION_DEMO
            cLib_addCalc2(&i_this->m43C, 1.0f, 1.0f, 0.04f);
#endif
...
#endif
            // Fall-through
        case MODE_BUNRI_DOUSA_134:
            {
                cLib_addCalc2(&i_this->mCSFovY, REG6_F(11) + 50.0f, 1.0f, 0.5f);
                f3 = std::fabsf(i_this->mCSCamCenter.x - (REG6_F(12) + -2340.0f));
                f3 *= REG6_F(18) + 0.1f;
                cLib_addCalc2(&i_this->mCSCamCenter.x, REG6_F(12) + -2340.0f, DEMO_SELECT(1.0f, 0.1f), DEMO_SELECT(f3, f3 * i_this->m43C));
                f3 = std::fabsf(i_this->mCSCamCenter.y - (REG6_F(13) + 36.0f));
                f3 *= REG6_F(18) + 0.1f;
                cLib_addCalc2(
                    &i_this->mCSCamCenter.y,
                    DEMO_SELECT(REG6_F(13) + 36.0f, REG12_F(13) + 186.0f),
                    DEMO_SELECT(1.0f, 0.5f),
                    DEMO_SELECT(f3, f3 * i_this->m43C)
                );
                f3 = std::fabsf(i_this->mCSCamCenter.z - (REG6_F(14) + 1442.0f));
                f3 *= REG6_F(18) + 0.1f;
                cLib_addCalc2(&i_this->mCSCamCenter.z, REG6_F(14) + 1442.0f, DEMO_SELECT(1.0f, 0.1f), DEMO_SELECT(f3, f3 * i_this->m43C));
                f3 = std::fabsf(i_this->mCSCamEye.x - (REG6_F(15) + -744.0f));
                f3 *= REG6_F(18) + 0.1f;
                cLib_addCalc2(&i_this->mCSCamEye.x, REG6_F(15) + -744.0f, 1.0f, DEMO_SELECT(f3, f3 * i_this->m43C));
                f3 = std::fabsf(i_this->mCSCamEye.y - (REG6_F(16) + 74.0f));
                f3 *= REG6_F(18) + 0.1f;
                cLib_addCalc2(&i_this->mCSCamEye.y, REG6_F(16) + 74.0f, 1.0f, DEMO_SELECT(f3, f3 * i_this->m43C));
                f3 = std::fabsf(i_this->mCSCamEye.z - (REG6_F(17) + -432.0f));
                f3 *= REG6_F(18) + 0.1f;
                cLib_addCalc2(&i_this->mCSCamEye.z, REG6_F(17) + -432.0f, 1.0f, DEMO_SELECT(f3, f3 * i_this->m43C));
#if VERSION > VERSION_DEMO
                cLib_addCalc2(&i_this->m43C, 1.0f, 1.0f, 0.04f);
#endif
                cLib_addCalc0(&i_this->m3AC.y, 1.0f, 3.0f);
                ...
                fopAcM_createDisappear(actor, &sp70, 0xF, daDisItem_HEART_CONTAINER_e);
        ...
        case MODE_BUNRI_DOUSA_135:
            {
                if (i_this->mSomeCountdownTimers[0] != 0) {
#if VERSION > VERSION_DEMO
                    cLib_addCalc2(&i_this->mCSCamCenter.y, REG12_F(13) + 186.0f, 0.3f, REG12_F(14) + 100.0f);
#endif
                    break;
                }
                ...
                i_this->mCSCamCenter.setall(0.0f);
                i_this->m3F0 = REG9_F(1) + 1400.0f;
                i_this->m3F4 = REG9_F(2) + -15000.0f;
                i_this->mCSCamEye.x = i_this->m3F0 * cM_ssin(i_this->m3F4);
                i_this->mCSCamEye.y = REG9_F(3) + 900.0f;
                i_this->mCSCamEye.z = i_this->m3F0 * cM_scos(i_this->m3F4);
                if (REG20_S(1) == 0) {
                    REG20_S(0) = 1;
                }
                if (REG20_S(0) == 0) {
        ...
        case MODE_BUNRI_DOUSA_136:
            {
                ...
                if (i_this->mSomeCountdownTimers[2] != 0) {
                    ...
                    cLib_addCalc2(&i_this->mCSFovY, REG9_F(6) + 50.0f, 1.0f, 0.5f);
                    ...
                    i_this->mCSCamEye.x = i_this->m3F0 * cM_ssin(i_this->m3F4);
                    cLib_addCalc2(&i_this->mCSCamEye.y, REG9_F(10) + 900.0f, 1.0f, REG9_F(11) + 10.0f);
                    i_this->mCSCamEye.z = i_this->m3F0 * cM_scos(i_this->m3F4);
                    break;
                }
                fVar2 = 0.0f;
                if (REG9_F(13) != fVar2) {
                    i_this->mMode = MODE_BUNRI_DOUSA_135;
                    i_this->mSomeCountdownTimers[0] = 0;
                    break;
                }
                if (REG9_F(12) != fVar2) {
    ...
    if (i_this->mMode >= MODE_BUNRI_DOUSA_120) {
        i_this->m3AC.y = 100.0f;
        i_this->m498 = 0.0f;
        i_this->m49C = 160.0f;
    }
    if (i_this->m474 != 0) {
        camera->mCamera.Set(i_this->mCSCamCenter, i_this->mCSCamEye, i_this->mCSFovY, 0);
    }
}

/* 00008D3C-0000A064       .text action_start_demo__FP9bpw_class */
static void action_start_demo(bpw_class* i_this) {
    fopAc_ac_c* actor = &i_this->actor;

    daPy_py_c* player = (daPy_py_c*)dComIfGp_getPlayer(0);
    camera_class* camera = dComIfGp_getCamera(dComIfGp_getPlayerCameraID(0));
    switch (i_this->mMode) {
        case MODE_START_DEMO_200:
            actor->scale.setall(0.0f);
            i_this->m47E = 0;
            i_this->mMode++;
        case MODE_START_DEMO_201:
            if (!actor->eventInfo.checkCommandDemoAccrpt()) {
                dComIfGp_event_onEventFlag(1);
                fopAcM_orderPotentialEvent(actor, dEvtFlag_STAFF_ALL_e, 0xFFFF, 0);
                actor->eventInfo.onCondition(dEvtCnd_UNK2_e);
                ...
                camera->mCamera.Stop();
                camera->mCamera.SetTrimSize(2);
                i_this->mCSFovY = REG6_F(0) + 55.0f;
                i_this->mSomeCountdownTimers[0] = REG9_F(0) + 40.0f;
                anm_init(i_this, dRes_INDEX_BPW_BCK_CORE1_e, 0.0f, J3DFrameCtrl::EMode_LOOP, 1.0f, -1);
                i_this->mMode++;
            }
            // Fall-through
        case MODE_START_DEMO_202:
            i_this->mCSCamCenter.set(72.0f, 103.0f, 1618.0f);
            i_this->mCSCamEye.set(89.0f, 108.0f, 1788.0f);
            if (i_this->mSomeCountdownTimers[0] != 0) {
                break;
            }
            if (REG20_S(1) == 0) {
            ...
            REG20_S(0) = 0;
            i_this->mSomeCountdownTimers[0] = REG9_F(1) + 50.0f;
            i_this->mMode++;
            // Fall-through
        case MODE_START_DEMO_203:
            i_this->mCSFovY = REG6_F(1) + 50.0f;
            i_this->mCSCamCenter.set(1646.0f, 1215.0f, -72.0f);
            i_this->mCSCamEye.set(1767.0f, 1321.0f, -129.0f);
            if (i_this->mSomeCountdownTimers[0] != 0) {
                break;
            }
            if (REG20_S(1) == 0) {
            ...
            REG20_S(0) = 0;
            i_this->mSomeCountdownTimers[0] = REG9_F(2) + 40.0f;
            i_this->mSomeCountdownTimers[1] = REG9_F(3) + 20.0f;
            i_this->mMode++;
            // Fall-through
        case MODE_START_DEMO_204:
            if (i_this->mSomeCountdownTimers[1] == 1) {
                i_this->m3EA = 1;
                mDoAud_bgmStreamPlay();
            }
            ...
            i_this->mSomeCountdownTimers[0] = REG9_F(4) + 38.0f;
            i_this->mSomeCountdownTimers[1] = REG9_F(5) + 28.0f;
            i_this->mMode++;
            // Fall-through
        case MODE_START_DEMO_205:
            i_this->mCSFovY = REG6_F(2) + 55.0f;
            i_this->mCSCamCenter.set(72.0f, 103.0f, 1618.0f);
            i_this->mCSCamEye.set(89.0f, 108.0f, 1788.0f);
            if (i_this->mSomeCountdownTimers[1] == 0) {
                i_this->m3EA = 2;
            ...
            REG20_S(0) = 0;
            i_this->mSomeCountdownTimers[0] = REG18_F(0) + 40.0f;
            i_this->mSomeCountdownTimers[1] = REG18_F(1) + 110.0f;
            i_this->mSomeCountdownTimers[2] = REG18_F(11) + 20.0f;
            i_this->mMode++;
#if VERSION > VERSION_DEMO
            i_this->m43C = 0.0f;
#endif
            // Fall-through
        case MODE_START_DEMO_206:
            ...
            f32 f3;
            f3 = std::fabsf(i_this->mCSFovY - (REG6_F(3) + 55.0f));
            f3 *= REG18_F(2) + 0.05f;
            cLib_addCalc2(&i_this->mCSFovY, REG6_F(3) + 55.0f, 1.0f, DEMO_SELECT(f3, f3 * i_this->m43C));
            f3 = std::fabsf(i_this->mCSCamCenter.x);
            f3 *= REG18_F(2) + 0.05f;
            cLib_addCalc2(&i_this->mCSCamCenter.x, 0.0f, DEMO_SELECT(1.0f, 0.1f), DEMO_SELECT(f3, f3 * i_this->m43C));
            f3 = std::fabsf(i_this->mCSCamCenter.y - 233.0f);
            f3 *= REG18_F(2) + 0.05f;
            cLib_addCalc2(&i_this->mCSCamCenter.y, 233.0f, DEMO_SELECT(1.0f, 0.1f), DEMO_SELECT(f3, f3 * i_this->m43C));
            f3 = std::fabsf(i_this->mCSCamCenter.z - 552.0f);
            f3 *= REG18_F(2) + 0.05f;
            cLib_addCalc2(&i_this->mCSCamCenter.z, 552.0f, DEMO_SELECT(1.0f, 0.1f), DEMO_SELECT(f3, f3 * i_this->m43C));
            f3 = std::fabsf(i_this->mCSCamEye.x);
            f3 *= REG18_F(2) + 0.05f;
            cLib_addCalc2(&i_this->mCSCamEye.x, 0.0f, 1.0f, DEMO_SELECT(f3, f3 * i_this->m43C));
            f3 = std::fabsf(i_this->mCSCamEye.y - 270.0f);
            f3 *= REG18_F(2) + 0.05f;
            cLib_addCalc2(&i_this->mCSCamEye.y, 270.0f, 1.0f, DEMO_SELECT(f3, f3 * i_this->m43C));
            f3 = std::fabsf(i_this->mCSCamEye.z - 722.0f);
            f3 *= REG18_F(2) + 0.05f;
            cLib_addCalc2(&i_this->mCSCamEye.z, 722.0f, 1.0f, DEMO_SELECT(f3, f3 * i_this->m43C));
#if VERSION > VERSION_DEMO
            cLib_addCalc2(&i_this->m43C, 1.0f, 1.0f, 0.04f);
#endif
            i_this->m3EA = 4;
            ...
            REG20_S(0) = 0;
            i_this->m3EA = 5;
            i_this->mSomeCountdownTimers[0] = REG18_F(3) + 30.0f;
            i_this->m480 = 0x96;
            fopAcM_seStart(actor, JA_SE_OBJ_BPW_MASK_APPEAR, 0);
            i_this->mMode++;
            // Fall-through
        case MODE_START_DEMO_207:
            cLib_addCalcAngleS2(&i_this->m47E, i_this->m480, 1, 5);
            cLib_addCalc2(&actor->scale.x, 1.0f, 1.0f, 0.1f);
            actor->scale.y = actor->scale.z = actor->scale.x;
            if (i_this->mSomeCountdownTimers[0] != 0) {
        ...
        case MODE_START_DEMO_208:
            ...
            if (REG20_S(0) == 0)
                break;
            REG20_S(0) = 0;
            i_this->mSomeCountdownTimers[0] = REG18_F(4) + 30.0f;
            i_this->mSomeCountdownTimers[1] = REG18_F(5) + 55.0f;
            i_this->mMode++;
#if VERSION > VERSION_DEMO
            i_this->m43C = 0.0f;
#endif
        case MODE_START_DEMO_209:
            {
                if (i_this->mSomeCountdownTimers[1] != 0) {
                    break;
                }
                f32 f3;
                f3 = std::fabsf(i_this->mCSFovY - (REG6_F(4) + 65.0f));
                f3 *= REG18_F(8) + 0.08f;
                cLib_addCalc2(&i_this->mCSFovY, REG6_F(4) + 65.0f, 1.0f, DEMO_SELECT(f3, f3 * i_this->m43C));
                f3 = std::fabsf(i_this->mCSCamCenter.x - 281.0f);
                f3 *= REG18_F(8) + 0.08f;
                cLib_addCalc2(&i_this->mCSCamCenter.x, 281.0f, DEMO_SELECT(1.0f, 0.1f), DEMO_SELECT(f3, f3 * i_this->m43C));
                f3 = std::fabsf(i_this->mCSCamCenter.y - 93.0f);
                f3 *= REG18_F(8) + 0.08f;
                cLib_addCalc2(&i_this->mCSCamCenter.y, 93.0f, DEMO_SELECT(1.0f, 0.1f), DEMO_SELECT(f3, f3 * i_this->m43C));
                f3 = std::fabsf(i_this->mCSCamCenter.z - 725.0f);
                f3 *= REG18_F(8) + 0.08f;
                cLib_addCalc2(&i_this->mCSCamCenter.z, 725.0f, DEMO_SELECT(1.0f, 0.1f), DEMO_SELECT(f3, f3 * i_this->m43C));
                f3 = std::fabsf(i_this->mCSCamEye.x - 336.0f);
                f3 *= REG18_F(8) + 0.08f;
                cLib_addCalc2(&i_this->mCSCamEye.x, 336.0f, 1.0f, DEMO_SELECT(f3, f3 * i_this->m43C));
                f3 = std::fabsf(i_this->mCSCamEye.y - 30.0f);
                f3 *= REG18_F(8) + 0.08f;
                cLib_addCalc2(&i_this->mCSCamEye.y, 30.0f, 1.0f, DEMO_SELECT(f3, f3 * i_this->m43C));
                f3 = std::fabsf(i_this->mCSCamEye.z - 877.0f);
                f3 *= REG18_F(8) + 0.08f;
                cLib_addCalc2(&i_this->mCSCamEye.z, 877.0f, 1.0f, DEMO_SELECT(f3, f3 * i_this->m43C));
#if VERSION > VERSION_DEMO
                cLib_addCalc2(&i_this->m43C, 1.0f, 1.0f, 0.04f);
#endif
                if (REG20_S(1) == 0) {
        ...
        case MODE_START_DEMO_210:
            {
                ...
                i_this->m554.remove();
#endif
                i_this->mSomeCountdownTimers[0] = REG6_F(5) + 40.0f;
    ...
    if ((i_this->m3F8 == 31) && (i_this->mpMorf->checkFrame(170.0f))) {
        fopAcM_monsSeStart(actor, JA_SE_CV_BPW_LAUGH_ENTER, 0);
    }
    if (((i_this->m3F8 == 31) && (i_this->mpMorf->getFrame() >= 170.0f)) || (i_this->m3F8 == 32)) {
        fopAcM_seStart(actor, JA_SE_CM_BPW_SWING_KANTERA, 0);
    }
    if (((i_this->m3F8 == 31) && (i_this->mpMorf->getFrame() >= 60.0f)) || (i_this->m3F8 == 32)) {
        fopAcM_seStart(actor, JA_SE_OBJ_BPW_FLYING, 0);
    }
    if (i_this->mMode >= MODE_START_DEMO_202) {
        camera->mCamera.Set(i_this->mCSCamCenter, i_this->mCSCamEye, i_this->mCSFovY, 0);
    }
    if (i_this->mMode >= MODE_START_DEMO_209) {
        bpw_class* lantern = (bpw_class*)fopAcM_SearchByID(i_this->m3FC);
        if (lantern != NULL) {
...
static void vib_mode_check(bpw_class* i_this) {
    switch (i_this->m3E8) {
        case 0:
            break;
        case 1:
...
static void kantera_calc(bpw_class* i_this) {
    fopAc_ac_c* actor = &i_this->actor;
    daPy_py_c* player = (daPy_py_c*)dComIfGp_getPlayer(0);
    bpw_class* pfVar4;
        ...
        if (pfVar4 != NULL) {
            switch (i_this->mAttWaitTimer) {
                ...
                case 0:
                    ...
                    break;
                case 1:
                    if (i_this->mAction != ACTION_START_DEMO) {
...
static void body_execute(bpw_class* i_this) {
    fopAc_ac_c* actor = &i_this->actor;
    ...
    if (CPad_CHECK_HOLD_Z(0) && CPad_CHECK_HOLD_DOWN(0)) {
        ...
        if (dComIfGp_getStartStageName()[0] == 'X') {
            ...
            if (i_this->m3FC != fpcM_ERROR_PROCESS_ID_e) {
                ...
                actor = &i_this->actor;
                fopAcM_createDisappear(actor, &actor->current.pos, 10, daDisItem_NONE3_e);
                fopAcM_delete(actor);
            }
        }
        return;
    ...
    if (REG8_S(2) != 0) {
        ...
        switch (i_this->mAction) {
            ...
            case ACTION_KOUGEKI:
                ...
                break;
            case ACTION_KARADA_TAORE:
                action_karada_taore(i_this);
                break;
            case ACTION_DAMAGE:
                action_damage(i_this);
                break;
            case ACTION_BUNRI_DOUSA:
...
static BOOL kantera_atari_check(bpw_class* i_this) {
    fopAc_ac_c* actor = &i_this->actor;
    cCcD_Obj* pcVar4;
...
static void action_kantera_dousa(bpw_class* i_this) {
    fopAc_ac_c* actor = &i_this->actor;
    s16 sVar4;
    fopAc_ac_c* pfVar2;
    ...
    switch (i_this->mMode) {
        ...
        case 4:
            ...
            actor->shape_angle.y += i_this->m464;
    ...
    if ((i_this->m3E4 != 0) && (i_this->mMode != 5)) {
        actor->speedF = 15.0f;
    ...
    if ((i_this->mMode != 4) && (kantera_atari_check(i_this))) {
        i_this->m464 = 0x2000;
        i_this->mKanteraDousaRot.x = 0;
        i_this->mKanteraDousaRot.y = 0;
        i_this->mKanteraDousaRot.z = 0;
...
static void kantera_execute(bpw_class* i_this) {
    fopAc_ac_c* actor = &i_this->actor;
    cCcD_Obj* pcVar2;
    cXyz local_28;
    ...
    if (i_this->mSomeCountdownTimers[0] == 0) {
        i_this->mSomeCountdownTimers[0] = cM_rndF(5.0f);
        i_this->m47E = cM_rndF(5.0f) + 8.0f;
    }
...
static void action_b_fire_1_dousa(bpw_class* i_this) {
    fopAc_ac_c* actor = &i_this->actor;
    f32 fVar1;
    f32 fVar2;
    cXyz local_c4;
    ...
    switch (i_this->mMode) {
        case 10:
            ...
            i_this->m534_demo = dComIfGp_particle_set(
                dPa_name::ID_AK_SN_BPWFLAMETHROWER00,
                &i_this->mFire1DousaPos,
                &i_this->mFire1DousaRot,
                NULL,
                0xFF,
            ...
            i_this->m538_demo = dComIfGp_particle_set(
                dPa_name::ID_AK_SN_BPWFLAMETHROWER01,
                &i_this->mFire1DousaPos,
                &i_this->mFire1DousaRot,
                NULL,
                0xFF,
                &i_this->mFire1Dousa_Pa_followEcallBack2
            );
#else
        ...
        case 11:
            ...
            if (dComIfG_Bgsp()->LineCross(&linChk)) {
                ...
                if (pla->GetNP()->y == 1.0f) {
                    ...
                    i_this->m67E.x = 0x4000;
                    i_this->m67E.y = cM_atan2s(fVar1, fVar2);
                }
#if VERSION == VERSION_DEMO
                if (i_this->m53C_demo == NULL) {
                    i_this->m53C_demo = dComIfGp_particle_set(dPa_name::ID_AK_SN_BPWFLAMETHROWER02, &i_this->m66C, &i_this->m67E, NULL, 0xFF, &i_this->m590);
                }
#else
                if (i_this->m590.getEmitter() == NULL) {
                    dComIfGp_particle_set(dPa_name::ID_AK_SN_BPWFLAMETHROWER02, &i_this->m66C, &i_this->m67E, NULL, 0xFF, &i_this->m590);
                }
#endif
            } else {
#if VERSION == VERSION_DEMO
...
static void action_b_fire_2_dousa(bpw_class* i_this) {
    daPy_py_c* player = (daPy_py_c*)dComIfGp_getPlayer(0);
    fopAc_ac_c* actor = &i_this->actor;
    cXyz local_30;
    ...
    switch (i_this->mMode) {
        case 20:
            ...
            i_this->m594_demo = dComIfGp_particle_set(
                dPa_name::ID_AK_SN_BPWFIRE00,
                &i_this->mFire1DousaPos,
                &i_this->mFire1DousaRot,
                NULL,
                0xFF,
                &i_this->mFireDousa2_Pa_followEcallBack
            );
            i_this->m598_demo = dComIfGp_particle_set(
                dPa_name::ID_AK_SN_BPWFIRE01,
                &i_this->mFire1DousaPos,
                &i_this->mFire1DousaRot,
                NULL,
                0xFF,
                &i_this->mFireDousa2_Pa_followEcallBack2
            );
#else
...
#endif
                if (i_this->mSomeCountdownTimers[1] == 0) {
                    i_this->mSomeCountdownTimers[1] = cM_rndF(5.0f);
                    i_this->m47E = cM_rndF(5.0f) + 8.0f;
                }
                i_this->mSomeCountdownTimers[0] = 90;
                actor->speedF = 0.0f;
        ...
        case 22:
            ...
            if (i_this->mSomeCountdownTimers[0] > 10) {
                if (i_this->mSomeCountdownTimers[1] == 0) {
                    i_this->mSomeCountdownTimers[1] = cM_rndF(5.0f);
                    i_this->m47E = cM_rndF(5.0f) + 8.0f;
                }
...
static void torituki_execute(bpw_class* i_this) {
    fopAc_ac_c* actor = &i_this->actor;
    ...
    switch (i_this->mMode) {
        ...
        case 1:
            ...
            if (!(actor->scale.x < 0.3f)) {
                ...
                i_this->mSomeCountdownTimers[8] = DEMO_SELECT(210, 150);
        ...
        case ACTOR_TYPE_KANTERA:
            ...
            if (i_this->m3E7 == 0) {
                ...
                if (emitter != NULL) {
                    ...
                    scale.set(vec2.x, vec2.y, vec2.x);
...
static BOOL boss_useHeapInit(fopAc_ac_c* a_this) {
    ...
    if (!i_this->mpLightFreezeBrkAnm
             ->init(model->getModelData(), (J3DAnmTevRegKey*)dComIfG_getObjectRes("BPW", dRes_INDEX_BPW_BRK_HIRARU1_e), true, J3DFrameCtrl::EMode_NONE))
    {
        return FALSE;
    }
    ...
    if (!i_this->mpLightStunBrkAnm
             ->init(model->getModelData(), (J3DAnmTevRegKey*)dComIfG_getObjectRes("BPW", dRes_INDEX_BPW_BRK_HIT_e), true, J3DFrameCtrl::EMode_LOOP))
    {
        return FALSE;
    }
    ...
    if (!i_this->mpCurseStartBrkAnm
             ->init(model->getModelData(), (J3DAnmTevRegKey*)dComIfG_getObjectRes("BPW", dRes_INDEX_BPW_BRK_NOROI_S1_e), true, J3DFrameCtrl::EMode_NONE))
    {
        return FALSE;
    }
    ...
    if (!i_this->mpCurseEndBrkAnm
             ->init(model->getModelData(), (J3DAnmTevRegKey*)dComIfG_getObjectRes("BPW", dRes_INDEX_BPW_BRK_NOROI_E1_e), true, J3DFrameCtrl::EMode_NONE))
    {
        return FALSE;
    }
    ...
    if (!i_this->mpDefaultBrkAnm
             ->init(model->getModelData(), (J3DAnmTevRegKey*)dComIfG_getObjectRes("BPW", dRes_INDEX_BPW_BRK_DEFAULT_e), true, J3DFrameCtrl::EMode_LOOP))
    {
        return FALSE;
    }
...
static void body_create_init(bpw_class* i_this) {
...
static BOOL kantera_useHeapInit(fopAc_ac_c* a_this) {
    ...
    i_this->mpMorf = new mDoExt_McaMorf(
        (J3DModelData*)dComIfG_getObjectRes("BPW", dRes_INDEX_BPW_BDL_BPW_KAN1_e),
        NULL,
        NULL,
        NULL,
...
static void kantera_create_init(bpw_class* i_this) {
    ...
    i_this->mAction = ACTION_DOUSA;
    i_this->mMode = MODE_DOUSA_0;
    i_this->m404 = fopAcM_GetLinkId(actor);
...
static void damage_ball_create_init(bpw_class* i_this) {
...
static void tori_create_init(bpw_class* i_this) {
    fopAc_ac_c* actor = &i_this->actor;
    daPy_py_c* player = (daPy_py_c*)dComIfGp_getPlayer(0);
    i_this->mBodyPos = actor->current.pos;
    fopAcM_OnStatus(actor, fopAcStts_UNK4000_e);
    ...
    if (res == cPhs_COMPLEATE_e) {
        ...
        switch (i_this->mType) {
            case ACTOR_TYPE_BODY:
                ...
                sp18.y += 0x4000;
                i_this->m3FC =
                    fopAcM_createChild(fpcNm_BPW_e, fopAcM_GetID(i_this), ACTOR_TYPE_KANTERA, &i_this->mChildActorPos, fopAcM_GetRoomNo(a_this), &sp18);
                i_this->mAttWaitTimer = 1;
                kantera_calc(i_this);
                if ((dComIfGp_getStartStageName()[0] != 'X') && (REG0_S(9) != 0 || (!dComIfGs_isStageBossDemo()))) {
                    ...
                    for (s32 i = 0; i < ARRAY_SSIZE(i_this->mChildPoeIds); i++) {
                    ...
                    i_this->m3EC = 1.0f;
                    kankyou_hendou(i_this);
                    i_this->mAction = ACTION_START_DEMO;
                    i_this->mMode = MODE_START_DEMO_200;
                } else {
                    if (dComIfGp_getStartStageName()[0] == 'X') {
                        mDoAud_bgmStart(JA_BGM_PAST_BIG_POW);
                    } else {
