...
bool daStandItem_c::actionFobj09() {
    ...
    if (f31 < 500.0f && !mbBckDidPlay) {
        ...
        if (m690 == NULL) {
            m690 = dComIfGp_particle_set(dPa_name::ID_AK_SN_FOUNTAINFIGURE00, &current.pos, &current.angle, NULL, 0xFF, NULL, fopAcM_GetRoomNo(this), &tevStr.mColorK0);
        } else {
