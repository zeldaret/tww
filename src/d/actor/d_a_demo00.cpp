        ...
        if (demo_actor->checkEnable(dDemo_actor_c::ENABLE_UNK_e)) {
            ...
            if (field_0x29c == 4) {
                static const u16 l_eventBit[] = {
                    /* 0x00 */ -1,
                    /* 0x01 */ dSv_event_flag_c::UNK_2A80,
                    /* 0x02 */ -1,
                    /* 0x03 */ -1,
                    /* 0x04 */ -1,
                    /* 0x05 */ dSv_event_flag_c::UNK_2401,
                    /* 0x06 */ -1,
                    /* 0x07 */ -1,
                    /* 0x08 */ -1,
                    /* 0x09 */ -1,
                    ...
                    /* 0x0F */ -1,
                    /* 0x10 */ -1,
                    /* 0x11 */ dSv_event_flag_c::UNK_2110,
                    /* 0x12 */ -1,
                    /* 0x13 */ -1,
                    /* 0x14 */ -1,
                    /* 0x15 */ -1,
                    /* 0x16 */ -1,
                    /* 0x17 */ dSv_event_flag_c::UNK_2D01,
                    /* 0x18 */ -1,
                    /* 0x19 */ -1,
                    /* 0x1A */ -1,
                    /* 0x1B */ -1,
                    ...
                    /* 0x2F */ -1,
                    /* 0x30 */ -1,
                    /* 0x31 */ dSv_event_flag_c::COLORS_IN_HYRULE,
                };
