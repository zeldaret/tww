...
daNpc_Bm1_HIO_c::daNpc_Bm1_HIO_c() {
    static daNpc_Bm1_childHIO_c::hio_prm_c a_prm_tbl[] = {
        {
            /* mMaxHeadX        */ 0x2000,
            /* mMaxHeadY        */ 0x0FA0,
            /* mMinHeadX        */ 0xF63C,
        ...
        },
        {
            ...
            /* mMinHeadY        */ 0xE000,
            /* mMaxBackboneX    */ 0x0000,
            /* mMaxBackboneY    */ 0x1036,
            /* mMinBackboneX    */ 0x0000,
            /* mMinBackboneY    */ 0xEFCA,
            /* mMaxTurnStep     */ 0x0479,
            /* mCalcAngleTarget */ 0x0000,
            /* mAttPosOffsetY   */ 209.0f,
            /* m18              */ 0,
            /* mFlyScale        */ 0,
            /* mFlyMaxStep      */ 0,
            /* m20              */ 0,
        ...
        },
        {
            ...
            /* mMinHeadY        */ 0xE000,
            /* mMaxBackboneX    */ 0x0000,
            /* mMaxBackboneY    */ 0x2000,
            /* mMinBackboneX    */ 0x0000,
            /* mMinBackboneY    */ 0xE000,
            /* mMaxTurnStep     */ 0x0640,
            /* mCalcAngleTarget */ 0x0578,
            /* mAttPosOffsetY   */ 220.0f,
            /* m18              */ 0,
            /* mFlyScale        */ 0,
            /* mFlyMaxStep      */ 0,
...
bool daNpc_Bm1_c::createInit() {
    static u8 a_att_dis_TBL[11][2] = {0xA9, 0xA9, 0xA9, 0xA9, 0x6D, 0x6D, 0x6F, 0x6D, 0xA9, 0xA9, 0x80,
                                      0x80, 0x80, 0x80, 0xA9, 0xA9, 0xA8, 0xA8, 0xA8, 0xA8, 0xAA, 0xAA};
    if (chk_appCnd() == 0) {
        return false;
    }
    for (int i = 0; i < 4; i++) {
    ...
    if (((fopAcM_GetParam(this) >> 16) & 0xFF) != 0xFF) {
        mPathRun.setInf((fopAcM_GetParam(this) >> 16) & 0xFF, fopAcM_GetRoomNo(this), true);
...
char* daNpc_Bm1_c::headAnmNum_toResID(int i_anmNum) {
    static char* a_BCKName_TBL[0x16] = {"bmhead01_dwait",   "bmhead01_fly01",    "bmhead01_lookup", "bmhead01_orooro",  "bmhead01_wait01",
                                        ...
                                        "bmhead01_wait01",  "bmhead01_wait01"};
    strcpy(l_BCKName, a_BCKName_TBL[i_anmNum]);
    return strcat(l_BCKName, ".bck");
}
...
void daNpc_Bm1_c::setAnm_tex(s8 i_param_1) {
...
BOOL daNpc_Bm1_c::setAnm_anm(anm_prm_c* i_anmPrmP) {
    ...
    dNpc_setAnmFNDirect(mpMorf, i_anmPrmP->loopMode, i_anmPrmP->morf, i_anmPrmP->speed, anmNum_toResID(mAnmNum), NULL, mArcName);
    mbHasArms = i_anmPrmP->hasArms == 1;
    if (mbHasArms) {
        dNpc_setAnmFNDirect(mpArmMorf, i_anmPrmP->loopMode, i_anmPrmP->morf, i_anmPrmP->speed, wingAnmNum_toResID(mAnmNum), NULL, mArcName);
    } else {
        dNpc_setAnmFNDirect(mpWingMorf, i_anmPrmP->loopMode, i_anmPrmP->morf, i_anmPrmP->speed, wingAnmNum_toResID(mAnmNum), NULL, mArcName);
    }
    dNpc_setAnmFNDirect(mpHeadMorf, i_anmPrmP->loopMode, i_anmPrmP->morf, i_anmPrmP->speed, headAnmNum_toResID(mAnmNum), NULL, mArcName);
...
void daNpc_Bm1_c::anmAtr(u16 i_param_1) {
    ...
    switch (i_param_1) {
        case 0x6: {
            ...
            u32 uVar1 = dComIfGp_getMesgAnimeTagInfo();
...
u16 daNpc_Bm1_c::next_msgStatus(u32* i_msg_no) {
    ...
    switch (*i_msg_no) {
        ...
        case 0x199E:
            *i_msg_no = 0x199F;
            break;
        case 0x199F:
            if (dComIfGs_getBeastNum(dBeastIdx_GOLDEN_FEATHER_e) >= 20) {
                *i_msg_no = 0x19A1;
            } else {
                *i_msg_no = 0x19A0;
            }
        ...
        case 0x19A1:
            switch (mpCurrMsg->mSelectNum) {
                case 0:
                    *i_msg_no = 0x19A3;
                    dComIfGp_setItemBeastNumCount(dBeastIdx_GOLDEN_FEATHER_e, -20);
                    break;
                case 1:
                    *i_msg_no = 0x19A2;
                    break;
...
u32 daNpc_Bm1_c::getMsg_BMB_2() {
    ...
    if (dComIfGs_isEventBit(dSv_event_flag_c::UNK_2120)) {
        return 0x1998;
    }
    return 0x1996;
}
...
void daNpc_Bm1_c::setAttention(bool i_setEyePos) {
    ...
    attention_info.position.set(current.pos.x, current.pos.y + l_hio_offset, current.pos.z);
...
void daNpc_Bm1_c::setPrtcl_Flyaway() {
    if (mAnmNum == 0xB && mpMorf->checkFrame(10.0f)) {
        ...
        if (mpFlyawayEmitterL != NULL) {
            mpFlyawayEmitterL->becomeImmortalEmitter();
        }

        if (mpFlyawayEmitterR != NULL) {
            JGeometry::TVec3<f32> rot(-1.0f, 1.0f, 0.0f);
            mpFlyawayEmitterR->becomeImmortalEmitter();
...
void daNpc_Bm1_c::setPrtcl_Land0() {
    if (mAnmNum == 0xD && mpMorf->checkFrame(1.0f)) {
        ...
        if (mpLandEmitterL != NULL) {
            mpLandEmitterL->becomeImmortalEmitter();
        }

        if (mpLandEmitterR != NULL) {
            JGeometry::TVec3<f32> rot(-1.0f, 0.5f, 0.0f);
            mpLandEmitterR->becomeImmortalEmitter();
...
void daNpc_Bm1_c::setPrtcl_Hane0() {
    delPrtcl_Hane0();
    mpFeatherEmitterL = dComIfGp_particle_set(dPa_name::ID_IT_SN_TORIZOKU_HANE00, &current.pos, NULL, NULL, 0xFF, NULL, fopAcM_GetRoomNo(this));
    mpFeatherEmitterR = dComIfGp_particle_set(dPa_name::ID_IT_SN_TORIZOKU_HANE00, &current.pos, NULL, NULL, 0xFF, NULL, fopAcM_GetRoomNo(this));
}
...
void daNpc_Bm1_c::setPrtcl_Hane1() {
    delPrtcl_Hane1();
    mpFeather1EmitterL = dComIfGp_particle_set(dPa_name::ID_IT_SN_TORIZOKU_HANE01, &current.pos, NULL, NULL, 0xFF, NULL, fopAcM_GetRoomNo(this));
#if VERSION > VERSION_DEMO
    if (mpFeather1EmitterL) {
        mpFeather1EmitterL->becomeImmortalEmitter();
    }
#endif
    mpFeather1EmitterR = dComIfGp_particle_set(dPa_name::ID_IT_SN_TORIZOKU_HANE01, &current.pos, NULL, NULL, 0xFF, NULL, fopAcM_GetRoomNo(this));
#if VERSION > VERSION_DEMO
    if (mpFeather1EmitterR) {
        mpFeather1EmitterR->becomeImmortalEmitter();
    }
#endif
}
...
cXyz daNpc_Bm1_c::eInit_calcRelativPos(cXyz* i_param_2, int* arg2) {
    ...
    cXyz local_28;
    if (i_param_2) {
        local_1c.set(i_param_2->x, i_param_2->y, i_param_2->z);
...
void daNpc_Bm1_c::eInit_ATTENTION_(int* i_prm_0_p, int* i_prm_1_p, int* i_prm_2_p, cXyz* i_offset_p, int* i_angle_p, int* i_index_p, int* i_timer_p) {
    ...
    switch (*i_prm_0_p) {
        ...
        case 6: {
            fopAc_ac_c* iVar1 = searchByID(mPartnerProcID);
            if (iVar1 == NULL) {
                return;
            }
            mLookBackState = 2;
    ...
    // !@bug Possible use of uninitialized variable
...
void daNpc_Bm1_c::event_actionInit(int arg0) {
    cXyz* offset_p = dComIfGp_evmng_getMyXyzP(arg0, "Offst");
    int* act_no_p = dComIfGp_evmng_getMyIntegerP(arg0, "ActNo");
    int* prm_0_p = dComIfGp_evmng_getMyIntegerP(arg0, "prm_0");
    int* prm_1_p = dComIfGp_evmng_getMyIntegerP(arg0, "prm_1");
    int* prm_2_p = dComIfGp_evmng_getMyIntegerP(arg0, "prm_2");
    int* angle_p = dComIfGp_evmng_getMyIntegerP(arg0, "Angle");
    int* index_p = dComIfGp_evmng_getMyIntegerP(arg0, "Index");
    int* timer_p = dComIfGp_evmng_getMyIntegerP(arg0, "Timer");
    int* anmno_p = dComIfGp_evmng_getMyIntegerP(arg0, "AnmNo");
    f32* speed_p = dComIfGp_evmng_getMyFloatP(arg0, "Speed");
    f32* accel_p = dComIfGp_evmng_getMyFloatP(arg0, "Accel");
    f32* spd_y_p = dComIfGp_evmng_getMyFloatP(arg0, "Spd_y");
    f32* acc_y_p = dComIfGp_evmng_getMyFloatP(arg0, "Acc_y");
...
BOOL daNpc_Bm1_c::set_action(ActionFunc i_action, void* i_param_2) {
...
BOOL daNpc_Bm1_c::_execute() {
    ...
    m_jnt.setParam(
        l_HIO.children[mType - 1].hio_prm.mMaxBackboneX,
        l_HIO.children[mType - 1].hio_prm.mMaxBackboneY,
        l_HIO.children[mType - 1].hio_prm.mMinBackboneX,
        l_HIO.children[mType - 1].hio_prm.mMinBackboneY,
        l_HIO.children[mType - 1].hio_prm.mMaxHeadX,
        l_HIO.children[mType - 1].hio_prm.mMaxHeadY,
        l_HIO.children[mType - 1].hio_prm.mMinHeadX,
        l_HIO.children[mType - 1].hio_prm.mMinHeadY,
...
J3DModelData* daNpc_Bm1_c::create_Anm() {
    ...
    mpMorf = new mDoExt_McaMorf(
        ...
        NULL,
        NULL,
        (J3DAnmTransform*)dComIfG_getObjectRes(mArcName, "bm_dwait.bck"),
...
J3DModelData* daNpc_Bm1_c::create_hed_Anm() {
    ...
    mpHeadMorf = new mDoExt_McaMorf(
        ...
        NULL,
        NULL,
        (J3DAnmTransform*)dComIfG_getObjectRes(mArcName, "bmhead01_dwait.bck"),
        J3DFrameCtrl::EMode_LOOP,
        1.0f,
        0,
        -1,
...
J3DModelData* daNpc_Bm1_c::create_wng_Anm() {
    ...
    mpWingMorf = new mDoExt_McaMorf(
        ...
        NULL,
        NULL,
        (J3DAnmTransform*)dComIfG_getObjectRes(mArcName, "bmwing_dwait.bck"),
        J3DFrameCtrl::EMode_LOOP,
        1.0f,
        0,
        -1,
...
J3DModelData* daNpc_Bm1_c::create_arm_Anm() {
    ...
    mpArmMorf = new mDoExt_McaMorf(
        ...
        NULL,
        NULL,
        (J3DAnmTransform*)dComIfG_getObjectRes(mArcName, "bmarm_wait01.bck"),
        J3DFrameCtrl::EMode_LOOP,
        1.0f,
        0,
        -1,
...
static BOOL daNpc_Bm1_ToFore(daNpc_Bm1_c*) {
    /* Unused stripped function */
    return TRUE;
}

static BOOL daNpc_Bm1_ToBack(daNpc_Bm1_c*) {
    /* Unused stripped function */
    return TRUE;
}
