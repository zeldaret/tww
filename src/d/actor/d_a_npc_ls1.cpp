...
void daNpc_Ls1_c::_Ls_hand_nodeCB_Hand_L(J3DNode* param_1, J3DModel* param_2) {
    ...
    param_2->setAnmMtx(jnt_no, mHand_L_Mtx);
}
...
void daNpc_Ls1_c::_Ls_hand_nodeCB_Hand_R(J3DNode* param_1, J3DModel* param_2) {
    ...
    param_2->setAnmMtx(jnt_no, mHand_R_Mtx);
}
...
void daNpc_Ls1_c::play_animation() {
    u32 snd_id = 0;
    if (mBtkResIDIndex == 0 && field_0x838 == 1) {
        setEyeCtrl();
    } else {
        clrEyeCtrl();
    }
...
void daNpc_Ls1_c::eye_ctrl() {
    ...
    if (field_0x839 != 0) {
        fVar1 = ((f32)m848 / (f32)l_HIO.mPrm.field_0x30);
        fVar2 = ((f32)m846 / (f32)l_HIO.mPrm.field_0x30);
...
void daNpc_Ls1_c::play_btk_anm() {
    u8 duration = mBtkAnm.getBtkAnm()->getFrameMax();
    if (field_0x838 != 0) {
        eye_ctrl();
    } else {
        field_0x704++;
...
void daNpc_Ls1_c::setAnm() {
    ...
    init_texPttrnAnm(a_anm_prm_tbl[field_0x851].mResIndex, true);
...
void daNpc_Ls1_c::setAnm_ATR(int param_1) {
    ...
    if (param_1 != 0) {
        init_texPttrnAnm(a_anm_prm_tbl[field_0x84B].mResIndex, true);
    }
...
void daNpc_Ls1_c::checkOrder() {
    ...
    if (command == 2) {
        if (dComIfGp_evmng_startCheck(mEventIDTbl[mEventIndex]) && field_0x850 >= 3) {
            switch (mEventIndex) {
            case 0:
...
fopAc_ac_c* daNpc_Ls1_c::searchByID(fpc_ProcID i_PID, int* i_param2) {
    fopAc_ac_c* actor_p;
...
void daNpc_Ls1_c::privateCut(int param_1) {
    ...
    mActionIndex = dComIfGp_evmng_getMyActIdx(param_1, a_cut_tbl, ARRAY_SSIZE(a_cut_tbl), 1, 0);
...
BOOL daNpc_Ls1_c::wait_2() {
    ...
    if (field_0x83F != 0) {
        ...
        if (field_0x833 != 0) {
            ...
            if (field_0x83E != 0 && mBckResIndex == 0) {
                field_0x853 = 1;
                return TRUE;
            } else {
                field_0x853 = 0;
...
bool daNpc_Ls1_c::demo() {
    if (demoActorID == 0) {
        ...
        if (demo_btp_p) {
            mBtpAnm.init(mpMorf->getModel()->getModelData(), demo_btp_p, 1, 0, 1.0f, 0, -1, true, 0);
            field_0x84D = 0xB;
            field_0x71C = 0;
        }
        ...
        if (demo_btk_p) {
            mBtkAnm.init(mpMorf->getModel()->getModelData(), demo_btk_p, true, J3DFrameCtrl::EMode_NONE, 1.0f, 0, -1, true, 0);
            mBtkResIDIndex = 3;
            field_0x704 = 0;
        }
...
#if VERSION > VERSION_DEMO
        dDemo_setDemoData(this, 0x6A, mpMorf, mArcName, 0, NULL, dBgS_GetGndMtrlSndId_Func(current.pos, 10.0f), dComIfGp_getReverb(fopAcM_GetRoomNo(this)));
#else
        dDemo_setDemoData(this, 0x6A, mpMorf, mArcName, 0, NULL);
#endif
    }
...
BOOL daNpc_Ls1_c::_draw() {
    ...
    mBtpAnm.entry(morf_model_info_p, field_0x71C);
    mBtkAnm.entry(morf_model_info_p, (f32)field_0x704);
    mpMorf->entryDL(); 
