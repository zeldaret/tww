...
void daNpc_Ls1_c::chngAnmAtr(u8 param_1) {
    ...
    switch (param_1) {
        case 1:
            mTimer2 = cLib_getRndValue(0x3C, 0x5A);
            break;
        case 3:
        case 5:
...
void daNpc_Ls1_c::setStt(s8 i_param) {
    u8 prev_m851 = m851;
    m851 = i_param;
    switch (m851) {
        case 1:
            m850 = 0;
            mTimer5 = cLib_getRndValue(0x3C, 0x5A);
            break;
        case 2:
            m850 = 0;
            m833 = 0;
...
BOOL daNpc_Ls1_c::wait_4() {
    ...
    if (mbAttention) {
        mTimer4 = cLib_getRndValue(0xF, 0x1E);
    }
