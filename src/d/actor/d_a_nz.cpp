...
static void daNZ_CreateInit(nz_class* i_this) {
    ...
    static f32 fire_sc[ARRAY_SIZE(i_this->mEnemyFire.mParticleScale)] = {
        1.0f, // NZ_NZ_JNT_KOSI_e
        1.0f, // NZ_NZ_JNT_HIP2_e
        1.0f, // NZ_NZ_JNT_SUNEL_e
        1.0f, // NZ_NZ_JNT_SUNER_e
        1.0f, // NZ_NZ_JNT_SHIPPO_e
        1.0f, // NZ_NZ_JNT_MUNE_e
        1.0f, // NZ_NZ_JNT_HEAD_e
        1.0f, // NZ_NZ_JNT_HANA_e
        1.0f, // NZ_NZ_JNT_KUTI_e
        1.0f  // NZ_NZ_JNT_HIP_e
    };
