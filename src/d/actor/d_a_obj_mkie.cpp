...
/**
 * d_a_obj_mkia.cpp
 * Elefant statue in earth temple, that dissovles when hit with light.
 */
...
BOOL daObjMkie::Act_c::CreateHeap() {
    ...
    JUT_ASSERT(0x19b, model_data_van != 0);
