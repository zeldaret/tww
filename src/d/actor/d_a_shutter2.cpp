...
const char* daShutter2_c::m_arcname[1] = {"Htobi3"};
const char* daShutter2_c::m_open_ev_name[1] = {"R04DOOROPEN"};
const char* daShutter2_c::m_close_ev_name[1] = {"R04DOORCLOSE"};
const char* daShutter2_c::m_staff_name[1] = {"Htobi3"};
