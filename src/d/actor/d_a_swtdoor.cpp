...
static BOOL daSwtdoor_Delete(swtdoor_class* i_this) {
    dComIfG_resDeleteDemo(&i_this->mPhs, "Swtdoor");
    return TRUE;
}
...
static BOOL useHeapInit(fopAc_ac_c* i_ac) {
    ...
    J3DModelData * modelData = (J3DModelData *)dComIfG_getObjectRes("Swtdoor", dRes_INDEX_SWTDOOR_BMD_SWTDOOR_e);
...
actor_process_profile_definition g_profile_SWTDOOR = {
    ...
    /* Proc Name    */ fpcNm_SWTDOOR_e,
    /* Proc SubMtd  */ &g_fpcLf_Method.base,
    /* Size         */ sizeof(swtdoor_class),
    /* Size Other   */ 0,
    /* Parameters   */ 0,
    /* Leaf SubMtd  */ &g_fopAc_Method.base,
    /* Draw Prio    */ fpcDwPi_SWTDOOR_e,
