...
void dMap_c::drawPointTbox(f32 param_1, f32 param_2, f32 param_3, f32 param_4) {
    ...
    local_10.b = 0;
    local_c.a = mAlpha;
    dMap_2DT2_c* box = &mTbox[mTboxNum];
    box->setPos(param_1, param_2);
    box->setColorW(local_c);
    box->setColorB(local_10);
    box->setWide(param_3 * 8.0f);
    box->setHeight(param_4 * 8.0f);
    box->setScaleX(1.0f);
    box->setScaleY(1.0f);
    box->setScissor(mScissorOrigX, mScissorOrigY, mScissorWidth, mScissorHeight);
    mTboxNum++;
}
