...
static cPhs_State dMeter_Create(msg_class* i_this) {
    ...
    mDoHIO_createChild("Message（会話）", &g_msgHIO); // "Message (Talk)"
    mDoHIO_createChild("Message（看板）", &g_messageHIO); // "Message (Sign)"
    mDoHIO_createChild("マップ２", &g_meter_mapHIO); // "Map 2"
